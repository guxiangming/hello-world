...
namespace Illuminate\Swoole\Http\Websocket\SocketIO;

use Swoole\Websocket\Frame;
use Illuminate\Swoole\Http\Websocket\Parser;
use Illuminate\Swoole\Http\Websocket\SocketIO\Packet;
use Illuminate\Swoole\Http\Websocket\SocketIO\Strategies\HeartbeatStrategy;
