...
use Illuminate\Swoole\Http\Server\Request;
use Illuminate\Swoole\Http\Websocket\Parser;
use Illuminate\Support\Facades\Facade;
use Illuminate\Swoole\Http\Websocket\Websocket;
use Illuminate\Swoole\Http\Websocket\HandlerContract;
use Illuminate\Swoole\Http\Websocket\Rooms\RoomContract;
...
trait CanWebsocket
{
    ...
    /**
     * @var Illuminate\Swoole\Http\Websocket\HandlerContract
     */
    protected $websocketHandler;

    /**
     * @var Illuminate\Swoole\Http\Websocket\Websocket
     */
    protected $websocket;

    /**
     * @var Illuminate\Swoole\Http\Websocket\Rooms\RoomContract
     */
    protected $websocketRoom;

    /**
     * @var Illuminate\Swoole\Http\Websocket\Parser
     */
    protected $parser;
    ...
    public function pushMessage(Server $server, array $data)
    {
       ...
       list($opcode, $sender, $fds, $broadcast, $assigned, $event, $message) = $this->normalizePushData($data);
     ...
     *
     * @param \Illuminate\Swoole\Http\Websocket\Parser $parser
     */
