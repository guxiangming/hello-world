...
use Exception;
use Illuminate\Swoole\Http\Server\Sandbox;
use Swoole\Http\Server as HttpServer;
use Illuminate\Support\Facades\Facade;
use Illuminate\Swoole\Http\Websocket\Websocket;
use Illuminate\Swoole\Http\Table\CanSwooleTable;
use Illuminate\Swoole\Http\Websocket\CanWebsocket;
...
class Manager
{
    ...
    /**
     * @var \Illuminate\Swoole\Http\Server\Application
     */
    ...
    /**
     * @var \Illuminate\Swoole\Http\Server\Sandbox
     */
    protected $sandbox;
     ...
     * Get application.
     *
     * @return \Illuminate\Swoole\Http\Server\Application
     */
