...
use Illuminate\Swoole\Http\Server\Application;
use Illuminate\Support\Facades\Facade;
use Illuminate\Support\ServiceProvider;
use Illuminate\Swoole\Http\Exceptions\SandboxException;
...
class Sandbox
{
     ...
     * Make a sandbox.
     *
     * @param \Illuminate\Swoole\Http\Server\Application
     * @return \Illuminate\Swoole\Http\Server\Sandbox
     */
