...
return [
    ...
    |--------------------------------------------------------------------------
    */
    'handler' => Illuminate\Swoole\Http\Websocket\SocketIO\WebsocketHandler::class,
    ...
    |--------------------------------------------------------------------------
    */
    'parser' => Illuminate\Swoole\Http\Websocket\SocketIO\SocketIOParser::class,
    ...
    */
    'middleware' => [
        // Illuminate\Swoole\Http\Websocket\Middleware\DecryptCookies::class,
        // Illuminate\Swoole\Http\Websocket\Middleware\StartSession::class,
        // Illuminate\Swoole\Http\Websocket\Middleware\Authenticate::class,
    ],
    ...
    */
    'drivers' => [
        'table' => Illuminate\Swoole\Http\Websocket\Rooms\TableRoom::class,
        'redis' => Illuminate\Swoole\Http\Websocket\Rooms\RedisRoom::class,
    ],
